...
OUT_DIR="${OUT_DIR:-$PROJECT_DIR/trim_threshold_samet}"
"$PYTHON_BIN" -m hygel_martini.param_opt.qm_to_martini.analysis.trim_threshold_samet_analysis --project-dir "$PROJECT_DIR" --out-dir "$OUT_DIR" "$@"
