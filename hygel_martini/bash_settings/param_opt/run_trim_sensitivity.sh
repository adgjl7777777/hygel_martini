...
OUT_DIR="${OUT_DIR:-$PROJECT_DIR/sensitivity}"
"$PYTHON_BIN" -m hygel_martini.param_opt.qm_to_martini.analysis.trim_sensitivity --project-dir "$PROJECT_DIR" --out-dir "$OUT_DIR" "$@"
