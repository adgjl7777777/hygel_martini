...
def generate_single_polymer_gro(
    ...
    # 고분자 구조 구성
    if polymer_config:
        Polymer.configure(polymer_config)
    ...
    writer.write_combined_itp(world, filename=itp_filename, moleculetype_name=moleculetype_name)
