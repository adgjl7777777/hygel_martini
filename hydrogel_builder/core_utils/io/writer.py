...
def write_combined_itp(world, filename, moleculetype_name):
    ...
    try:
        ...
        # default True: rich 섹션을 기본 포함, 문제 시 validation 모드로 skip/중단 선택
    ...
    if emit_rich and extras:
        ...
        try:
            ...
            # strict 모드에서는 validation error를 그대로 올림
            raise
